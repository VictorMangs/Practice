...
# Pull rhel-jdk image
# podman pull docker.io/jenkins/jenkins:rhel-ubi9-jdk17

# Build jenkins with blue ocean
# podman build -t myjenkins-blueocean:2.426.2-1 -f Dockerfile.jenkinsBlueOcean_rhel
...
# Get admin password
password=`podman exec jenkins-blueocean /bin/cat /var/jenkins_home/secrets/initialAdminPassword`
